...
// The enterprise "Statement of Results" sheet for a sitting (issue #78). Rendered
// by SessionConsole into a hidden wrapper — it is NOT shown on screen; the "Print
// Result" button in the session's status card clones it into the print iframe via
// usePrint. Letterhead frame, summary, subject-average bars, the ranked results
// table, and a signature footer. (Previously the standalone /results page.)
import { forwardRef } from "react";
import { PrintDocument } from "@/components/print/print-document";
import { SignatureLine } from "@/components/print/blocks";
...
export type ResultsDocumentProps = {
...
export const ResultsDocument = forwardRef<HTMLDivElement, ResultsDocumentProps>(function ResultsDocument(
  { collegeName, examTitle, label, mode, totalMarks, roster, subjects, subjectMarks, subjectAvgs, printedOn },
  ref,
) {
  const graded = roster
  ...
  return (
    <PrintDocument ref={ref} docLabel="Statement of Results">
      ...
      {/* Performance chart — subject averages only. */}
